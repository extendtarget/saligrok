                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified align-items-center">
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#editItemCategory" data-catid="{{ $itemCategory->id }}" data-catname="{{ $itemCategory->name }}"
                                            class="btn btn-sm btn-primary editItemCategory"> {{ __('storeDashboard.edit')}}
                                     </a>
                                   <div class="checkbox checkbox-switchery ml-1" style="padding-top: 0.8rem;">
                                       ...
                                       {{-- extend by aya --}}
                                <form action="{{ route('restaurant.deleteItemCategory', $itemCategory->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm btn-danger ml-1">{{__('storeDashboard.delete')}}</button>
                                </form>
                                  {{-- extend by aya -------------------  --}}
                                </div>
                            </td>
