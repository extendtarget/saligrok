...
<div class="content">
                ...
                <form action="{{ route('admin.updateRestaurant') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="d-lg-flex justify-content-lg-left">
                        <ul class="nav nav-pills flex-column mr-lg-3 wmin-lg-250 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a href="#offerSettings" class="nav-link" data-toggle="tab">
                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            ...
                            <div class="tab-pane fade show active" id="generalSettings">
                                ...
                                <!-- added by qusay -->
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">is order need approval by admin:</label>
                                    <div class="col-lg-9">
                                       <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if($restaurant->is_order_need_approval_by_admin) checked="checked" @endif name="is_order_need_approval_by_admin">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="offerSettings">
                                <legend class="font-weight-semibold text-uppercase font-size-sm">
                                    Offer Settings
                                </legend>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">Enable Item Offers</label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if($restaurant->item_offers) checked="checked" @endif
                                                name="item_offers">
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">Minimum Subtotal for Item Offer:</label>
                                    <div class="col-lg-9">
                                        <input value="{{ $restaurant->item_offer_min_subtotal }}" type="number"
                                            class="form-control form-control-lg" name="item_offer_min_subtotal"
                                            placeholder="Minimum Subtotal for Item Offer in {{ config('setting.currencyFormat') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">Free Items:</label>
                                    <div class="col-lg-9">
                                        <select multiple="multiple" class="form-control freeItems" data-fouc
                                            name="free_items[]">
                                            @foreach ($selectedItems as $item)
                                            <option value="{{ $item->id }}" class="text-capitalize"
                                                {{ isset($restaurant) && in_array($item->id, json_decode($restaurant->free_items)) ? 'selected' : '' }}>
                                ...
                                <script>
                                    $('.freeItems').select2({
                                        ...
                                        ajax: { 
                                            url: "{{ url('admin/store')}}/{{ $restaurant->id }}/items",
                                            type: "get",
                                            dataType: 'json',
                                            delay: 250,
                            ...
                            <div class="tab-pane fade" id="deliverySettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">Free delivery Distance:</label>
                                    <div class="col-lg-9">
                                        <input value="{{ $restaurant->free_delivery_distance }}" type="text"
                                            class="form-control form-control-lg free_delivery_distance"
                                            name="free_delivery_distance"
                                            placeholder="Free delivery maximum distance">
                                    </div>
                                </div>
                                
                                <!--free delivery cost by mohamed-->
                                    <div class="form-group row align-items-center">
                                        <label class="col-lg-3 col-form-label">Free delivery Cost:</label>
                                        <div class="col-lg-3">
                                            <input value="{{ $restaurant->free_delivery_cost }}" type="text"
                                                class="form-control form-control-lg"
                                                name="free_delivery_cost"
                                                placeholder="Free delivery cost" min="0">
                                        </div>
                                    
                                        <label class="col-lg-3 col-form-label">Delivery guy comm :</label>
                                        <div class="col-lg-3">
                                            <div class="input-group input-group-lg">
                                                <input value="{{ $restaurant->free_delivery_comm }}" type="text"
                                                    class="form-control"
                                                    name="free_delivery_comm"
                                                    placeholder="Delivery guy commission"
                                                    aria-describedby="percentage-addon" min="0" max="100">
                                ...
                                <!-- added by qusay -->
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">Show Time On Order Accept:</label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                                    @if($restaurant->show_time_on_order_accept) checked="checked" @endif name="show_time_on_order_accept">
                                            </label>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="col-lg-9">
        <div class="checkbox checkbox-switchery mt-2">
            <label>
                <input type="hidden" name="is_schedulable" value="0">
                <input value="1" type="checkbox" class="switchery-primary" @if($restaurant->is_schedulable) checked="checked" @endif name="is_schedulable">
            </label>
        </div>
    ...
    $(function () {
      ...
      if (Array.prototype.forEach) {
       ...
       $('.base_delivery_charge').numeric({ allowThouSep:false, maxDecimalPlaces: 2, allowMinus: false });
        ...
        // Aya 
   $('.actual_delivery_charge').numeric({ allowThouSep: false, maxDecimalPlaces: 2, allowMinus: false });
    $('.commission_rate').numeric({ allowThouSep: false, maxDecimalPlaces: 2, allowMinus: false, max: 100 });
     });
</script>
@endsection