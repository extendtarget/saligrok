    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-navigation">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a href="javascript:void(0)"
                        class="navbar-nav-link dropdown-toggle {{ Request::is('admin/orders')  || Request::is('admin/live-orders') ? 'active' : '' }}"
                        data-toggle="dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        @can('live_orders_view')
                        <a href="{{ route("admin.liveOrder") }}"
                            class="navbar-nav-link {{ Request::is('admin/live-orders') ? 'active' : '' }}">
                            <i class="icon-basket mr-2"></i>
                            Live Orders
                        </a>
                        @endcan
                        <a href="{{ route("admin.cancelReasons") }}"
                            class="navbar-nav-link {{ Request::is('admin/cancel-reasons') ? 'active' : '' }}">
        ...
        <div class="dropdown-menu">
            <div class="row extra-menu">
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ route('admin.deliveryGuyEarningsByDateReport') }}" class="dropdown-item {{ Request::is('reports/delivery-guy-earnings-by-date') ? 'active' : '' }}">
                        <i class="icon-truck mr-2"></i>
                        Delivery Guy Earnings By Date
                    </a>
                </div>
                <div class="col-md-6">
                ...
                @can('delivery_guys_view')
                <div class="col-md-6">
                    <a href="{{ route('admin.deliveryGuyActiveRecordReport') }}" class="dropdown-item {{ Request::is('reports/delivery-guys-timing-report') ? 'active' : '' }}">
                        <i class="icon-watch mr-2"></i>
                        Delivery Guy Timing Report
                    </a>
                </div>
                @endcan
            </div>
