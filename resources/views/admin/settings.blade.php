    ...
    <div class="col-md-12">
        <div class="card" style="min-height: 100vh;">
            <div class="card-body">
                <form action="{{ route('admin.saveSettings') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-lg-flex justify-content-lg-left">
                        <ul class="nav nav-pills flex-column mr-lg-3 wmin-lg-250 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a href="#referAndEarnSettings" class="nav-link" data-toggle="tab">
                                    <i class="icon-users mr-2 custom-color-{{ rand(1, 8) }} settings-icon"></i>
                                    Refer and Earn Settings
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#customerAppSettings" class="nav-link" data-toggle="tab">
                                    <i class="icon-users4 mr-2 custom-color-{{ rand(1,8) }} settings-icon"></i>Customer
                                    Application
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="#androidAppSettings" class="nav-link" data-toggle="tab">
                                    <i class="icon-android mr-2 custom-color-2 settings-icon"></i>
                                ...
                                {{-- <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="storeUrl"
                                            value="{{ config('setting.storeUrl') }}"
                                placeholder="Enter website URL like: https://yourdomain.com" readonly="readonly">
                            </div>
                        </div> --}}
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <span class="help-text small text-danger">Cronjob setup is require. <a
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Send Rating Message and
                                    Notifications after: </strong></label>
                            <div class="col-lg-9">
                                <select name="ratingNotificationDelay"
                                    class="form-control form-control-lg select">
                                    <option value="20"
                                        @if (config('setting.ratingNotificationDelay') == '20') selected @endif>20 Minutes
                                    </option>
                                    <option value="25"
                                        @if (config('setting.ratingNotificationDelay') == '25') selected @endif>25 Minutes
                                    </option>
                                    <option value="30"
                                        @if (config('setting.ratingNotificationDelay') == '30') selected @endif>30 Minutes
                                    </option>
                                    <option value="45"
                                        @if (config('setting.ratingNotificationDelay') == '45') selected @endif>45 Minutes
                                    </option>
                                    <option value="60"
                                        @if (config('setting.ratingNotificationDelay') == '60') selected @endif>60 Minutes
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="designSettings">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 offset-lg-3">
                                <img src="{{ substr(url('/'), 0, strrpos(url('/'), '/')) }}/{{ config('setting.firstScreenHeroImage') }}"
                                    alt="firstScreenHeroImage" class="img-fluid mb-2" style="width: 70px;">
                            </div>
                            @endif
                            <label class="col-lg-3 col-form-label"><strong>Hero Image: </strong></label>
                            <div class="col-lg-9">
                                <input type="file" class="form-control-uniform" name="firstScreenHeroImage" accept="image/x-png"
                                    data-fouc>
                                <span class="help-text small">Image dimension 512x512 (PNG image only)</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Store App Primary Color</strong></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control colorpicker-show-input"
                                    name="storeAppPrimaryColor" data-preferred-format="rgb"
                                    value="{{ config('setting.storeAppPrimaryColor') }}">
                            </div>
                        </div>
                        @endif
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control colorpicker-show-input"
                                    ...
                                    value="{{ config('setting.recommendedBadgeColor') }}">
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="referAndEarnSettings">
                        <legend class="font-weight-semibold text-uppercase font-size-sm">
                            Refer and Earn Settings
                        </legend>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Enable Refer &
                                    Earn</strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if (config('setting.enableReferAndEarn') == 'true') checked="checked" @endif
                                            name="enableReferAndEarn">
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Referral Bonus
                                    Type:</strong></label>
                            <div class="col-lg-9">
                                <select name="referralBonusType"
                                    class="form-control form-control-lg select">
                                    <option value="order"
                                        @if (config('setting.referralBonusType') == 'order') selected @endif>On 1st Order
                                    </option>
                                    <option value="registration"
                                        @if (config('setting.referralBonusType') == 'registration') selected @endif>
                                        On Registration</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Referral Bonus to New User in
                                    {{ config('setting.currencyFormat') }}:</strong></label>
                            <div class="col-lg-9">
                                <input type="number" class="form-control form-control-lg"
                                    name="referralSuccessAmountReferredUser"
                                    value="{{ config('setting.referralSuccessAmountReferredUser') }}"
                                    placeholder="Referral Bonus to New User in {{ config('setting.currencyFormat') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Referral Bonus to Referring User in
                                    {{ config('setting.currencyFormat') }}:</strong></label>
                            <div class="col-lg-9">
                                <input type="number" class="form-control form-control-lg"
                                    name="referralSuccessAmountReferringUser"
                                    value="{{ config('setting.referralSuccessAmountReferringUser') }}"
                                    placeholder="Referral Bonus to Referring User in {{ config('setting.currencyFormat') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Minimum Order Amount for Successful
                                    Referral {{ config('setting.currencyFormat') }}:</strong></label>
                            <div class="col-lg-9">
                                <input type="number" class="form-control form-control-lg"
                                    name="minimumSuccessfulReferralOrderAmount"
                                    value="{{ config('setting.minimumSuccessfulReferralOrderAmount') }}"
                                    placeholder="Minimum Order Amount for Successful Referral in {{ config('setting.currencyFormat') }}">
                                <span class="text-muted text-small">This will be used if Referral Bonus Type
                                    is set to 'On 1st Order'</span>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pushNotificationSettings">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.enablePushNotification')=="true" ) checked="checked"
                                            @endif name="enablePushNotification">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="firebaseSenderId"
                                    value="{{ config('setting.firebaseSenderId') }}"
                        ...
                        <span><strong class="text-danger">IMPORTANT</strong> To learn how Subscribers, Push
                            Notifications, and Alerts work <a
                                href="https://docs.foodomaa.com/faqs/push-notifications-and-alerts"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="oneSignalRestApiKey"
                                    value="{{ config('setting.oneSignalRestApiKey') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg"
                                    name="restaurantNewOrderNotificationMsg"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="googleLoginButtonText"
                                    value="{{ config('setting.googleLoginButtonText') }}"
                    ...
                    <div class="tab-pane fade" id="mapSettings">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.showMap')=="true" ) checked="checked" @endif
                                            name="showMap">
                                    </label>
                                </div>
                            </div>
                        ...
                        <hr>
                        <a href="https://docs.foodomaa.com/configurations/google-maps-api-keys" target="_blank"
                            rel="nofollow">Click
                            Here</a>
                    ...
                    <div class="tab-pane fade" id="paymentGatewaySettings">
                        ...
                        @endforeach
                        <hr>
                        <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/stripe.png"
                                alt="Stripe" style="width: 35px"> Stripe</h2>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select name="stripeLocale" class="form-control form-control-lg select">
                                    ...
                                    <option value="es-419" @if(config('setting.stripeLocale')=="es-419" ) selected
                                        @endif>Spanish
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.stripeCheckoutPostalCode')=="true" ) checked="checked"
                                            @endif name="stripeCheckoutPostalCode">
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.stripeAcceptIdealPayment')=="true" ) checked="checked"
                                            @endif name="stripeAcceptIdealPayment">
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.stripeAcceptFpxPayment')=="true" ) checked="checked"
                                            @endif name="stripeAcceptFpxPayment">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <hr>
                        <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/paypal.png"
                                alt="PayPal" style="width: 35px"> PayPal</h2>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select name="paypalEnv" class="form-control form-control-lg select">
                                    <option value="sandbox" @if(config('setting.paypalEnv')=="sandbox" ) selected
                                        @endif>Sandbox
                                        (Testing)</option>
                                    <option value="production" @if(config('setting.paypalEnv')=="production" ) selected
                                        @endif>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Razorpay Merchant Id: <i
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <p class="mb-0"><a href="https://docs.foodomaa.com/faqs/razorpay-webhooks"
                                        target="_blank">Click
                                        here</a> to
                        ...
                        <h2> <img
                                src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/mercadopago.png"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="mercadopagoAccessToken"
                                    value="{{ config('setting.mercadopagoAccessToken') }}"
                        ...
                        <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/paytm.png"
                                alt="Paytm" style="width: 35px"> Paytm</h2>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select name="paytm_environment" class="form-control form-control-lg select">
                                    <option @if(config('setting.paytm_environment')=="local" ) selected @endif
                                        value="local">Local
                                    </option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="paytm_industry_type"
                                    value="{{ config('setting.paytm_industry_type') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="paytm_channel"
                                    value="{{ config('setting.paytm_channel') }}"
                        ...
                        <hr>
                        <h2> <img
                                src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/flutterwave.png"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="flutterwavePublicKey"
                                    value="{{ config('setting.flutterwavePublicKey') }}"
                        ...
                        <hr>
                        <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/khalti.png"
                                alt="Khalti" style="width: 35px"> Khalti</h2>
                        <div class="form-group row">
                    ...
                    <div class="tab-pane fade" id="smsGatewaySettings">
                        ...
                        <div id="msg91Settings" class="@if (config('setting.defaultSmsGateway') != " 1") hidden @endif">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-lg"
                                        name="msg91NewOrderDltTemplateId"
                        ...
                        <div id="twilioSettings" class="@if (config('setting.defaultSmsGateway') != " 2") hidden
                            @endif">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-lg" name="twilioAccessToken"
                                        value="{{ config('setting.twilioAccessToken') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-lg" name="twilioFromPhone"
                                        value="{{ config('setting.twilioFromPhone') }}"
                        ...
                        <div class="form-group row @if(config('setting.enOLnR') == " true") hidden @endif"
                            id="enSOVBlock">
                    ...
                    <div class="tab-pane fade" id="emailSettings">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select name="defaultEmailGateway" class="form-control form-control-lg select">
                                    ...
                                    <option @if(config('setting.defaultEmailGateway')=="smtp" ) selected @endif
                                        value="smtp">Custom
                                        SMTP</option>
                                </select>
                            </div>
                        ...
                        <hr>
                        <div id="sendgridSettings" class="@if (config('setting.defaultEmailGateway') != " sendgrid")
                            hidden @endif">
                            <div class="form-group row">
                        ...
                        <div id="smtpSettings" class="@if (config('setting.defaultEmailGateway') != " smtp") hidden
                            @endif">
                            <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="email" class="form-control form-control-lg"
                                    name="sendEmailFromEmailAddress"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.sendOrderInvoiceOverEmail')=="true" ) checked="checked"
                                            @endif name="sendOrderInvoiceOverEmail">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <button type="button" class="btn btn-primary btn-md" id="toggleSendTestEmail"
                                autocomplete="false"> Send
                                Test
                                Email</button>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <div class="text-right">
                                            <button type="button"
                                                class="btn btn-primary btn-labeled btn-labeled-left btn-lg"
                                                data-dismiss="modal">
                ...
                $('#sendTestEmailNow').click(function(event) {
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.enableGoogleAnalytics')=="true" ) checked="checked"
                                            @endif name="enableGoogleAnalytics">
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="customerAppSettings">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.enCODonSF')=="true" ) checked="checked" @endif
                                            name="enCODonSF">
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Sort Delivery stores by
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.showPwaInstallPromptFooter')=="true" ) checked="checked"
                                            @endif name="showPwaInstallPromptFooter">
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.showCustomerVatNumber')=="true" ) checked="checked"
                                            @endif name="showCustomerVatNumber">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.showAddonPricesOnCart')=="true" ) checked="checked"
                                            @endif name="showAddonPricesOnCart">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-3 col-lg-3 col-form-label">
                                <label><strong>Tip Percentage <i class="icon-question3 ml-1" data-popup="tooltip"
                                            title="Type any Percentage Amount and hit Enter on your Keyboard"
                                            data-placement="top">
                                        </i> </strong></label>
                            </div>
                            <div class="col-md-9 tipss">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.countQuantityAsTotalItemsOnCart')=="true" )
                                            checked="checked" @endif name="countQuantityAsTotalItemsOnCart">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Search Bar on Homepage <i
                                        class="icon-question3 ml-1" data-popup="tooltip"
                                        title="This will override the default coupon success message"
                                        data-placement="top"></i>
                                </strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.mockSearchOnHomepage')=="true" ) checked="checked"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select name="footerStyleType" class="form-control form-control-lg select">
                                    <option value="FIXED" @if(config('setting.footerStyleType')=="FIXED" )
                                        selected="selected" @endif>Fixed Style
                                    </option>
                                    <option value="FLOAT" @if(config('setting.footerStyleType')=="FLOAT" )
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.showCouponDescriptionOnSuccess')=="true" )
                                            checked="checked" @endif name="showCouponDescriptionOnSuccess">
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.enGDMA')=="true" ) checked="checked" @endif
                                            name="enGDMA">
                                        <b><span class="mt-1"><span class="text-danger"> IMPORTANT: </span>Donot enable
                                                ...
                                                target="_blank"> this documentation.</a><br>You will get a loading
                                            screen on the Cart page if this documentation is not followed.</b>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.showInActiveItemsToo')=="true" ) checked="checked"
                                            @endif name="showInActiveItemsToo">
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.flatApartmentAddressRequired')=="true" )
                                            checked="checked" @endif name="flatApartmentAddressRequired">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.enDelChrRnd')=="true" ) checked="checked" @endif
                                            name="enDelChrRnd">
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.showGdpr')=="true" ) checked="checked" @endif
                                            name="showGdpr">
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            ...
                                            checked="checked" @endif name="sortSelfpickupStoresByDistance">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.showPercentageDiscount')=="true" ) checked="checked"
                                            @endif name="showPercentageDiscount">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.enableDeliveryGuyEarning')=="true" ) checked="checked"
                                            @endif name="enableDeliveryGuyEarning">
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                --}}
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.showUserInfoBeforePickup')=="true" ) checked="checked"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.showOrderAddonsDelivery')=="true" ) checked="checked"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.showPriceAndOrderCommentsDelivery')=="true" )
                                            checked="checked" @endif name="showPriceAndOrderCommentsDelivery">
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.showDeliveryCollection')=="true" ) checked="checked"
                                            @endif name="showDeliveryCollection">
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Assign Nearest Delivery Guy
                                    Automatically
                                </strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            ...
                                            checked="checked" @endif name="autoAssignNearestDeliveryGuy">
                                    </label>
                                </div>
                            </div>
                        </div>
                        @if(config('setting.autoAssignNearestDeliveryGuy')=="true")
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Delay for Auto-Assigning
                                    Drivers:<i class="icon-question3 ml-1" data-popup="tooltip"
                                        title="This is the time which is used to add a delay in the auto-assigning of drivers on an accepted order. Time is in minutes."
                                        data-placement="top"></i></strong></label>
                            <div class="col-lg-9">
                                <input type="number" step="1" min="0" max="30"
                                    class="form-control form-control-lg" name="autoAssignDeliveryGuyDelay"
                                    value="{{ config('setting.autoAssignDeliveryGuyDelay') }}"
                                    placeholder="This is the time (in minutes) by which the auto-assign delivery guy function is delayed.">
                            </div>
                        </div>
                        @endif
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Enable Delivery Guy Incentive
                                </strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input id="enableDeliveryGuyIncentiveSwitch" value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.enableDeliveryGuyIncentive')== "true") checked="checked"
                                            @endif name="enableDeliveryGuyIncentive">
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div id="incentiveData" class="@if(config('setting.enableDeliveryGuyIncentive')=="false") d-none @endif">
                            @if(config('setting.enableDeliveryGuyIncentive')=="true")
                            <div id="incentives">
                                @if(!empty(config('setting.deliveryGuyIncentiveData')))
                                    @foreach(json_decode(config('setting.deliveryGuyIncentiveData')) as $incentiveData)
                                        <div class="form-group row">
                                            <div class="col-lg-3">
                                                <label class="col-form-label">Order Count</label>
                                                <input type="number" class="form-control form-control-lg" value="{{$incentiveData->order_count}}"
                                                    name="order_count[]" required>
                                            </div>
                                            <div class="col-lg-3">
                                                <label class="col-form-label">Incentive Amount</label>
                                                <input type="number" class="form-control form-control-lg" value="{{$incentiveData->incentive_amount}}"
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <button type="button" class="remove-incentive btn btn-danger" data-popup="tooltip" data-placement="right"
                            ...
                            <button type="button" id="add-incentive" class="btn btn-secondary btn-labeled btn-labeled-left mr-2 mt-2"> <b><i
                                        class="icon-plus22"></i></b>Add Incentive</button>
                            @endif
                            <hr>
                            <script>
                                $(document).ready(function() {
                                    // Add new incentives form fields
                                    $('#add-incentive').click(function() {
                                        var html ="<div class='form-group row'> <div class='col-lg-3'><label class='col-form-label'>Order Count</label><input type='number' class='form-control form-control-lg' name='order_count[]'> </div> <div class='col-lg-3'> <label class='col-form-label'>Incentive Amount</label><input type='number' class='form-control form-control-lg' name='incentive_amount[]'> </div> <div class='col-lg-2'> <label class='col-form-label text-center' style='width: 43px'></span><i class='icon-circle-down2'></i></label><br><button type='button' class='btn btn-danger remove-incentive'><i class='icon-cross2'></i></button></div></div>";
                                        $('#incentives').append(html);
                                    });

                                    // Remove incentives form fields
                                    $('#incentives').on('click', '.remove-incentive', function() {
                    ...
                    <div class="tab-pane fade" id="restaurantDashboardSettings">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Hide Customer Details on
                                    Order</strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.hideCustomerDetailsFromStoreOwner')=="true" )
                                            checked="checked" @endif name="hideCustomerDetailsFromStoreOwner">
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select name="restaurantNewOrderRefreshRate"
                                    class="form-control form-control-lg select">
                                    <option value="5" @if(config('setting.restaurantNewOrderRefreshRate')=="5" )
                                        selected @endif>
                                        Fetch Every 5 Seconds</option>
                                    <option value="15" @if(config('setting.restaurantNewOrderRefreshRate')=="15" )
                                        selected @endif>
                                        Fetch Every 15 Seconds</option>
                                    <option value="25" @if(config('setting.restaurantNewOrderRefreshRate')=="25" )
                                        selected @endif>
                                        Fetch Every 25 Seconds</option>
                                    <option value="30" @if(config('setting.restaurantNewOrderRefreshRate')=="30" )
                                        selected @endif>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select name="restaurantNotificationAudioTrack"
                                    class="form-control form-control-lg select" id="restaurantNotificationTone">
                                    @foreach($notificationAudioFileNames as $audioFileName)
                                    <option value="{{ $audioFileName }}"
                                        @if(config('setting.restaurantNotificationAudioTrack')==$audioFileName) selected
                                        @endif>
                    ...
                    <div class="tab-pane fade" id="androidAppSettings">
                        <legend class="font-weight-semibold text-uppercase font-size-sm">
                            Android Apps Settings
                        </legend>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.iHaveFoodomaaAndroidApp')=="true" ) checked="checked"
                                            @endif name="iHaveFoodomaaAndroidApp">
                                        <p class="small mb-0">Make sure to enable this setting if you have purchased the
                                            <a href="https://shop.foodomaa.com/store/android-customer-mobile-application"
                                                target="_blank">Foodomaa Customer Android App</a></p>
                                        <p class="small mb-0 text-danger"><strong>DONOT</strong> enable if you have not
                                            purchased the app</p>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.iHaveFoodomaaDeliveryApp')=="true" ) checked="checked"
                                            @endif name="iHaveFoodomaaDeliveryApp">
                                        <p class="small mb-0">Make sure to enable this setting if you have purchased the
                                            <a href="https://shop.foodomaa.com/store/android-delivery-mobile-application"
                                                target="_blank">Foodomaa Delivery Android App</a></p>
                                        <p class="small mb-0 text-danger"><strong>DONOT</strong> enable if you have not
                                            purchased the app</p>
                                    </label>
                                </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>I have Foodomaa Store Android App
                                    <i class="icon-question3 ml-1" data-popup="tooltip"
                                        title="Push notification will not work properly if this config is not correctly set. If you have the Foodomaa Store App, enable this setting, else keep it disabled"
                                        data-placement="top"></i></strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.iHaveFoodomaaStoreApp')=="true" ) checked="checked"
                                            @endif name="iHaveFoodomaaStoreApp">
                                        <p class="small mb-0">Make sure to enable this setting if you have purchased the
                                            <a href="https://shop.foodomaa.com/store/store-partner-application-android"
                                                target="_blank">Foodomaa Store Android App</a></p>
                                        <p class="small mb-0 text-danger"><strong>DONOT</strong> enable if you have not
                                            purchased the app</p>
                                    </label>
                                </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>I have Foodomaa SocketPush Service
                                    <i class="icon-question3 ml-1" data-popup="tooltip"
                                        title="Push notification will not work at all if this config is not correctly set. If you have purchased SocketPush Service, enable this setting, else keep it disabled"
                                        data-placement="top"></i></strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                        <input value="true" type="checkbox" class="switchery-primary"
                                            @if(config('setting.hasSocketPush')=="true" ) checked="checked" @endif
                                            name="hasSocketPush">
                                        <p class="small mb-0">Make sure to enable this setting if you have purchased the
                                            <a href="https://shop.foodomaa.com/store/socketpush-service-for-foodomaa"
                                                target="_blank">Foodomaa SocketPush Service</a></p>
                                        <p class="small mb-0 text-danger"><strong>DONOT</strong> enable if you have not
                                            purchased the SocketPush Service</p>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Firebase RealTime Database
                                    URL</strong></label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg"
                                    name="firebaseRealtimeDatabaseUrl"
                                    value="{{ config('setting.firebaseRealtimeDatabaseUrl') }}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <a href="javascript:void(0)" data-type="CACHE" data-popup="tooltip" title="Double Click to Execute"
                        data-placement="right" class="btn btn-secondary btn-labeled btn-labeled-left"
                        id="forceClearCache"> <b><i class="icon-arrow-right7"></i></b> Force Clear Cache</a>
                    <hr>
            ...
            <div class="tab-pane fade" id="fixUpdateIssues">
                ...
                <a href="{{ route('admin.fixUpdateIssues') }}" class="btn btn-lg btn-primary"
                    id="fixUpdateIssuesButton">Fix
                    Issues Now</a>
            </div>
            <div class="tab-pane fade" id="advanceSettings">
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('admin.filesBackup') }}"
                        class="btn btn-info btn-labeled btn-labeled-left backupBtn mr-2">
                ...
                <div class="mt-4">
                    <button class="btn btn-danger btn-labeled btn-labeled-left mr-2" data-popup="tooltip"
                        title="On click of this button, you will be asked to confirm this action."
                        ...
                        <div class="modal-body">
                            ...
                            <p> <b>Note: </b>
                                <span class="text-danger"><b>DONOT</b> close this window or reload during the cleaning
                                    process. </span></p>
                            <a href="{{ route('admin.deleteJunkActivityLogs') }}"
                                class="btn btn-lg btn-danger d-block mt-3">
                                Proceed to Clean
                            </a>
                        </div>
                    </div>
