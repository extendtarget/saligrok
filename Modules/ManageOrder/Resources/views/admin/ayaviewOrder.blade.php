                ...
                <div class="card" id="printThis">
                    <div class="p-3">
                        ...
                        <div class="text-right mt-3">
                                    ...
                                    <div class="col-md-12 p-2 mb-3"
                                            ...
                                            @foreach ($order->orderitems as $item)
                                                <div>
                                                    <div class="d-flex mb-1 align-items-start" style="font-size: 1.2rem;">
                                                        ...
                                                        <strong class="mr-1"
                                                            style="width: 100%;">{{ $item->name }}</strong>
                                                        @php
                                                            $itemTotal =
                                                                ($item->price +
                                                                    calculateAddonTotal($item->order_item_addons)) *
                                                                $item->quantity;
                                                            $itemTotalwithoutAddon = $item->price * $item->quantity;
                                                            $subTotal = $subTotal + $itemTotal;
                                                        @endphp
                                                        <span
                                                            class="badge badge-flat border-grey-800 text-default">{{ config('setting.currencyFormat') }}{{ $itemTotalwithoutAddon }}</span>
                                                    </div>
                                                    ...
                                                    @endif
                                                    @if (!$loop->last)
                                                        <div class="mb-2" style="border-bottom: 2px solid #dcdcdc;">
                                                        </div>
                                                    @endif
                                                </div>
                                            @endforeach
                                        @else
                                            ...
                                            <div>
                                                <div class="d-flex mb-1 align-items-start" style="font-size: 1.2rem;">
                                                    <span
                                                        class="badge badge-flat border-grey-800 text-default mr-2 order-item-quantity">{{ $taskDetails->task }}</span>
                                                    <strong class="mr-1"
                                                        style="width: 100%;">{{ $taskDetails->task_comment }}</strong>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                            ...
                            <!--            <td class="td-data"> {{ config('setting.currencyFormat') }}{{ $subTotal }}-->
                            <!--            </td>-->
                            <!--        </tr>-->
                            ...
                            <!--                        ({{ config('setting.currencyFormat') }}{{ $order->coupon_amount }})-->
                            <!--                    @endif-->
                            <!--                </td>-->
                            <!--            </tr>-->
                            <!--        @endif-->
                            ...
                            <!--                <td class="td-data">-->
                            <!--                    {{ config('setting.currencyFormat') }}{{ $order->restaurant_charge }}-->
                            <!--                </td>-->
                            <!--            </tr>-->
                            <!--        @endif-->
                            <!--        <tr>-->
                            ...
                            <!--            <tr>-->
                            <!--                <td class="text-left td-title">Paid With {{ config('setting.walletName') }}-->
                            <!--                </td>-->
                            <!--                <td class="td-data">-->
                            ...
                            <!--                <td class="td-data">-->
                            <!--                    {{ config('setting.currencyFormat') }}{{ $order->round_off_amount }} </td>-->
                            <!--            </tr>-->
                            <!--        @endif-->
                            <!--        <tr>-->
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-data">
                                                        ...
                                                        @php
                                                            ...
                                                            if ($coupon && $coupon->is_used_for_delivery && $order->delivery_charge == 0) {
                                                                $coupon_amount = 0; 
                                                                \Log::info('Coupon ignored in view: Delivery charge is zero', [
                                                                    'order_id' => $order->id,
                                                                    'coupon_code' => $order->coupon_name
                                                                ]);
                                                            } elseif ($coupon && $coupon->is_used_for_delivery && $order->actual_delivery_charge != $order->delivery_charge) {
                                                        ...
                                                        @elseif ($coupon && $coupon->is_used_for_delivery && $order->delivery_charge == 0)
                                                            <span class="text-warning" style="font-size: 0.9rem;">(Ignored: Free Delivery)</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endif
                                                ...
                                                <td class="td-data">
                                                    ...
                                                    @if ($order->coupon_name != null)
                                                        @php
                                                            $coupon = \App\Coupon::where('code', $order->coupon_name)->first();
                                                        @endphp
                                                        @if ($coupon && $coupon->is_used_for_delivery && $order->actual_delivery_charge != $order->delivery_charge)
                                                            <span class="text-success" style="font-size: 0.9rem;">(Coupon Discount Applied)</span>
                                                        @endif
                                                    @endif
                                                </td>
                                            </tr>
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.updateOrder', $order->id) }}" method="POST" id="order-update-form">
                        <div class='col-lg-12 form-group row'>
                            <div class='col-lg-4'>
                                <label class="col-form-label" style="margine-bottom: 0px; padding-bottom: 0px;">Order
                                    Type:</label>
                            </div>
                            <div class='col-lg-4'>
                                <select name="delivery_type" class="form-control form-control-lg">
                                    <option value="1" @if ($order->delivery_type == 1) selected @endif>Delivery
                                    </option>
                                    <option value="2" @if ($order->delivery_type == 2) selected @endif>Self-Pickup
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class='col-lg-12 form-group row'>
                            <div class='col-lg-4'>
                                <label class="col-form-label" style="margine-bottom: 0px; padding-bottom: 0px;">Free
                                    Delivery:</label>
                            </div>
                            <div class='col-lg-4'>
                                <input value="true" type="checkbox" class="switchery-primary" name="free_delivery"
                                    id="free_delivery">
                            </div>
                        </div>
                        <script>
                        ...
                        <div class='col-lg-12 form-group row' id="deliveryChargeRow">
                            ...
                            <div class='col-lg-12 form-group row'>
                                <div class='col-lg-4'>
                                    <label class="col-form-label" style="margine-bottom: 0px; padding-bottom: 0px;">Restaurant
                                        Charge:</label>
                                </div>
                                <div class='col-lg-4'>
                        ...
                        <div class='col-lg-12 form-group row'>
                            <div class='col-lg-4'>
                                <label class="col-form-label" style="margine-bottom: 0px; padding-bottom: 0px;">Item
                                    Name</label>
                            </div>
                            <div class='col-lg-2'>
                                <label class="col-form-label"
                                    style="margine-bottom: 0px; padding-bottom: 0px;">Qty</label>
                            </div>
                            <div class='col-lg-2'>
                                <label class="col-form-label"
                                    style="margine-bottom: 0px; padding-bottom: 0px;">Price</label>
                            </div>
                            <div class='col-lg-2'>
                                <label class="col-form-label"
                                    style="margine-bottom: 0px; padding-bottom: 0px;">Subtotal</label>
                            </div>
                        </div>
                        @foreach ($order->orderitems as $item)
                            <div class='form-group row'>
                                ...
                                <div class='col-lg-2'>
                                    <input value="{{ $item->quantity }}" type='number' disabled
                                        class='form-control  form-control-lg text-right' placeholder='0'>
                                </div>
                                <div class='col-lg-2'>
                                ...
                                <div class='col-lg-2'>
                                    <input type='text' value="{{ number_format($item->quantity * $item->price, 2) }}"
                                        disabled class='form-control  form-control-lg text-right' placeholder='0'>
                                </div>
                                <div class='col-lg-2'>
                                    ...
                                    <div class='col-lg-12 form-group row'>
                                        <div class='col-lg-5'>
                                            <label class="col-lg-5 col-form-label"
                                                style="margine-bottom: 0px; padding-bottom: 0px;">Addon Category:</label>
                                        </div>
                                        <div class='col-lg-3'>
                                            <label class="col-lg-3 col-form-label"
                                                style="margine-bottom: 0px; padding-bottom: 0px;">Addon:</label>
                                        </div>
                                        <div class='col-lg-2'>
                                        ...
                                        <div class='col-lg-12 form-group row'>
                                            <div class='col-lg-5'>
                                                <input value="{{ $addon->addon_category_name }}" type='text' disabled
                                                    ...
                                                    placeholder='Addon Category Name' name='names[]'>
                                            </div>
                                            <div class='col-lg-3'>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.deliveryGuyCurrentOrdersButton', function() {
                var id = $(this).data('id');
                $.ajax({
                    url: "{{ route('admin.getDeliveryGuyCurrentOrders', ':id') }}".replace(':id',
                        id),
                    type: 'GET',
                    success: function(data) {
                        if (data.length > 0) {
                            ...
                            table +=
                                '<thead><tr><th>Order ID</th><th>Customer Name</th><th>Restaurant Name</th><th>Customer Address</th></thead><tbody>';
                            data.forEach(function(order) {
                                var order_url =
                                    "{{ route('admin.viewOrder', ':order_id') }}"
                                    .replace(':order_id', order.unique_order_id)
                                table += '<tr>';
                                table += '<td><strong><a href="' + order_url +
                                    '" target="_blank">' + order.unique_order_id +
                                    '</a></strong></td>';
                            ...
                            $('#deliveryGuyCurrentOrderModalBody').html(
                                '<h6>No current orders for this delivery guy.</h6>');
                        }
                        // Show the modal
            ...
            $('#getDeliveryGuys').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var table =
                            '<div class="table-responsive" style="padding: 0.75rem"><table id="deliveryGuysTable" class="table table-sm"><thead><tr><th class="d-none">ID</th><th>Name</th><th>Distance</th><th>Max Order Limit</th><th>Orders</th><th>Action</th></tr></thead><tbody>';
                        var length = 0;
                        ...
                        for (var i = 0; i < length; i++) {
                            ...
                            table += '<tr>';
                            table += '<td class="d-none">' + deliveryGuy.delivery_guy_id +
                                '</td><td>' + deliveryGuy.name + '</td><td>' + deliveryGuy
                                .distance +
                                ' km</td><td>' + deliveryGuy.max_order_limit + '</td><td><button type="button" class="deliveryGuyCurrentOrdersButton btn btn-sm btn-dark" data-id="' +
                                deliveryGuy.delivery_guy_id + '">' + deliveryGuy
                                .current_orders_count + '</button></td>';

                          //riad  if ({{ $order->orderstatus_id }} == 1 ||
                            //    {{ $order->orderstatus_id }} == 2) {
                            //    table +=
                             //       '<td><form method="POST" action="{{ route('admin.assignDeliveryFromAdmin') }}">@csrf<input type="hidden" name="order_id" value="{{ $order->id }}"><input type="hidden" name="user_id" value="' +
                             //       deliveryGuy.delivery_guy_id +
                               //     '"><input type="hidden" name="customer_id" value="{{ $order->id }}"><button class="btn btn-sm btn-success" type="submit">Assign</button></form></td>';
                         //   }

                        //    if ({{ $order->orderstatus_id }} == 3 ||
                          //      {{ $order->orderstatus_id }} == 4) {
                         //       table +=
                          //          '<td><form method="POST" action="{{ route('admin.reAssignDeliveryFromAdmin') }}">@csrf<input type="hidden" name="order_id" value="{{ $order->id }}"><input type="hidden" name="user_id" value="' +
                         //           deliveryGuy.delivery_guy_id +
                         //           '"><input type="hidden" name="customer_id" value="{{ $order->id }}"><button class="btn btn-sm btn-success" type="submit">Re-assign</button></form></td>';
                        //    }
