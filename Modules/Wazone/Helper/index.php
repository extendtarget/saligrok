      ...
      <div class="section">
        <div class="columns is-centered">
          <div class="column is-two-fifths">
            <center>
              <h1 class="title" style="padding-top: 20px">Whatsapp Module Activator</h1><br>
            </center>
            <div class="box">
             <?php
              $license_code = null;
              ...
              if(!empty($_POST['license'])&&!empty($_POST['client'])){
                ...
                if($activate_response['status'] != true){ ?>
                  <form action="/Modules/Whatsapp/index.php" method="POST">
                    <div class="notification is-danger is-light"><a href="/Modules/Whatsapp/deac.php"><?php echo ucfirst($msg)." CLICK HERE TO DE-ACTIVATE!"; ?></a></div>
                    <div class="field">
